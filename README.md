...
It's important to note there is no GUI for this game, so in essence, it cannot be played as one would think. The board game concept is largely to create a project where OO principles can be applied.
