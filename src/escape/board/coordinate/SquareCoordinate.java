...
public class SquareCoordinate extends TwoDimensionalCoordinate {
	...
	/*
	 * @see escape.board.coordinate.Coordinate#distanceTo(escape.board.coordinate.
	 * Coordinate)
	 */
	@Override
	...
	private boolean isPerfectlyDiagonal(SquareCoordinate to) {
		return calcSimpleDistance(this.getX(), to.getX()) == calcSimpleDistance(this.getY(), to.getY());
	}
